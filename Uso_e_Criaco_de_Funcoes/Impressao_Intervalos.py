...
# A Função deve imprimir o intervalo dos números informados:
    # Primeiro em ordem crescente e em seguida, em ordem decrescente
# Faça uma chmada da função para testa-la
